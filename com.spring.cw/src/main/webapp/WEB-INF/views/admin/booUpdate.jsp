	...
	<h2>예약 수정</h2><hr>
		<form name="myform" method="post">
			...
			<div style="margin-left: 100px;">
				<button type="button" onclick="location.href='${ctp}/admin/viewBooking?FA_NO=${vo.FA_NO}&BOOKING_USEDAY=&BOOKING_STATUS=&BOOKING_APPROVAL=&BOOKING_PAYMENT=&CW_USER_NAME=&CW_USER_NUMBER=';">이전</button>
