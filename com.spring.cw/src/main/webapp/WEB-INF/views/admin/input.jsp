...
<script>
	...
	function inputOn(){
		...
		if(FA_GROUP == ""){
 		...
 		else if(document.getElementById("file").value != "" || uExt != null){
		...
		<form name="myform" method="post" enctype="multipart/form-data" >
			<table>
				...
				<tr>
					...
					<td><input type="text" id="FA_FNAME" name="FA_FNAME" /></td>
				</tr>
				<tr>
					<td style="width:15%; background-color: #ddd; text-align: center;">기관명 *</td>
					<td><input type="text" id="FA_INAME" name="FA_INAME" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<input type="checkbox" id="FA_AP_CH" name="FA_AP_CH" value="Y" /> 상시접수
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="number" id="FA_PEOPLE_NO" name="FA_PEOPLE_NO" />명</td>
				</tr>
				<tr>
					<td style="width:15%; background-color: #ddd; text-align: center;">문의전화 *</td>
					<td><input type="text" id="FA_NUMBER" name="FA_NUMBER" /></td>
				</tr>
				<tr>
					<td style="width:15%; background-color: #ddd; text-align: center;">이용대상 *</td>
					<td>
						<input type="checkBox" name="FA_TARGET" id="FA_TARGET2" value="일반" onclick="inputhalin()" />일반
						<input type="checkBox" name="FA_TARGET" id="FA_TARGET3" value="아동" onclick="inputhalin()" />아동
						<input type="checkBox" name="FA_TARGET" id="FA_TARGET4" value="청소년" onclick="inputhalin()" />청소년
						<input type="checkBox" name="FA_TARGET" id="FA_TARGET5" value="장애인" onclick="inputhalin()" />장애인
						<input type="checkBox" name="FA_TARGET" id="FA_TARGET6" value="외국인" onclick="inputhalin()" />외국인
						<input type="checkBox" name="FA_TARGET" id="FA_TARGET1" value="직접입력" onclick="inputhalin()" />직접입력
						<input type="text" id="FA_TARGETSELF" name="FA_TARGET" readonly >
					</td>
				</tr>
				<tr>
					<td style="width:15%; background-color: #ddd; text-align: center;">이용요금 *</td>
					<td><input type="number" id="FA_PAY" name="FA_PAY" />원 | <input type="checkbox" id="FA_PAY1" name="FA_PAY1" value="0" onclick="payCheck()" />무료</td>
				</tr>
				<tr>
					<td style="width:15%; background-color: #ddd; text-align: center;">상세정보</td>
					<td><textarea id="FA_DETAILED" name="FA_DETAILED"></textarea></td>
				</tr>
				<tr>
					<td style="width:15%; background-color: #ddd; text-align: center;">유의사항</td>
					<td><textarea id="FA_ATTENTION" name="FA_ATTENTION"></textarea></td>
				</tr>
				<tr>
					<td style="width:15%; background-color: #ddd; text-align: center;">사진파일</td>
					<td><input type="file" id="file" name="file" accept=".jpg,.png,.jpeg,.gif,.bmp" required /></td>
				</tr>
				<tr>
